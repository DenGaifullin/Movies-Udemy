...
public class JsonUtils {
    ...
    private static final String RUS_LANGUAGE = "ru";
    private static final String ENG_LANGUAGE = "en";
//    private static int page = 1;
    ...
    public static JSONObject getJsonObjectSortedByPopularity(String sortedByPopularityDesc, int page){
    ...
    public static ArrayList<Movie> getArrayListFromJsonObj(JSONObject jsonObject){
